...
OutputDir=..\Setup
OutputBaseFilename=UpdateIt-@VER_MAJOR@.@VER_MINOR@.@VER_BUILD@@VER_SUFFIX@-setup
...
Source: "..\CrashReporter\Output.2008\x86\@BUILD_TYPE@\@CHARACTER_SET@\CrashReporter.exe"; DestDir: "{app}"
