...
#ifndef __REGISTRYDEFINES_H
#define __REGISTRYDEFINES_H

#define XCRASHREPORT_DUMP_REGISTRY
#define XCRASHREPORT_REGISTRY_KEY	_T("HKCU\\Software\\Elijah Zarezky\\UpdateIt!")

#endif   // __REGISTRYDEFINES_H
