...
OutputDir=..\Setup
OutputBaseFilename=UpdateIt-1.4.4885-setup-universal
VersionInfoVersion=1.4.4885
...
Source: "..\CrashReporter\Output.2008\x86\Release\MBCS\CrashReporter.exe"; DestDir: "{app}"; Components: core
