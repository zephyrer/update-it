...
CDetailsDialog::CDetailsDialog(CDWordArray * paFileDetails, CWnd* pParent /*=NULL*/)
...
void CDetailsDialog::InitListCtrl(CXListCtrl& list)
{
	...
	VERIFY(list.m_cImageList.Create(IDB_XLISTCTRL_CHECKBOXES, 16, 3, RGB(255, 0, 255)));
...
void CDetailsDialog::FillList(CXListCtrl& list)
{
	list.DeleteAllItems();
...
void CDetailsDialog::DisplayFile(FILEDETAILS *fd)
{
...
void CDetailsDialog::DisplayHex(const char * lpBuf, DWORD dwSize)
{
...
///////////////////////////////////////////////////////////////////////////////
// OnDblClick
void CDetailsDialog::OnDblClick(NMHDR* pNMHDR, LRESULT* pResult)
{
	*pResult = 0;
	...
	TRACE(_T("in CDetailsDialog::OnDblClick:  %d, %d\n"), nItem, nSubItem);
